 ...
 * @head: address of pointer to node of the head
 * @str: str field of node
 * @num: node index used by history
 *
 * Return: size of list
 */
list_t *add_node(lis_t **head, const char *str, int num)
{
	lis_t *new_head;
 ...
 * @head: address of pointer to the node of the head
 * @str: str field of node
 * @num: node index
 *
 * Return: list size
 */
list_t *add_node_end(lis_t **head, const char *str, int num)
{
	lis_t *new_node, *node;
...
/**
 * print_list_str - prints the str  of a list_t
 * @h: pointer to first node
 *
 * Return: list size
 */
size_s print_list_str(const lis_t *h)
{
	size_s i = 0;
